...
[[Python PEP-440]](https://www.python.org/dev/peps/pep-0440/) | [[Wiki-Software_versioning]](https://en.wikipedia.org/wiki/Software_versioning) | [[Github  Semantic Versioning]](https://semver.org/lang/zh-CN/) | [[知乎介绍]](https://www.zhihu.com/question/20289602/answer/20068112)



## Github Sematic Versioning

考虑使用这样的版本号格式：

**X.Y.Z （主版本号.次版本号.修订号）**

修复问题但不影响API 时，递增修订号 (**修复了一个 bug**)；

API 保持向下兼容的新增及修改时，递增次版本号 (**增加了新功能**)；

进行不向下兼容的修改时，递增主版本号 (**例如 Python2 —> Python3**)。
